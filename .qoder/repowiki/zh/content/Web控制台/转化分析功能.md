...
前端分析组件主要位于 `web/src/app/console/conversions` 目录下，提供了完整的转化分析界面：
...
- [analytics.go:13-32](file://server/api/internal/handler/analytics.go#L13-L32)
...
- [analytics.go:119-201](file://server/api/internal/handler/analytics.go#L119-L201)
...
后端分析处理器针对 ClickHouse 进行了专门的查询优化：
...
**章节来源**
- [analytics.go:76-112](file://server/api/internal/handler/analytics.go#L76-L112)
- [analytics.go:203-276](file://server/api/internal/handler/analytics.go#L203-L276)
...
- **数据存储**：ClickHouse 作为单一数据源，简化了数据访问逻辑
