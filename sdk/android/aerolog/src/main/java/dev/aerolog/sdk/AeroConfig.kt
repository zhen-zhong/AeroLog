 ...
 *
 * @property serverUrl Collector 服务地址。SaaS 用户可省略，默认走官方集群
 *                    [DEFAULT_SERVER_URL]；私有化部署请显式覆盖，例如
 *                    https://collector.example.com 或本地联调 http://10.0.2.2:8081。
...
data class AeroConfig(
    ...
    companion object {
        ...
        const val DEFAULT_SERVER_URL: String = "https://collector.aerolog.cc"
    }
}
